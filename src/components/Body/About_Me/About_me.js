               ...
               <div className="details">
                  <Grid spacing={5} container>
                     <Grid className="inner__details" item sm={7}>
                        <p>
                           Hello! I'm Rafio, a self-taught fullstack Web
                           Developer from Dhaka, BD.
                        </p>
                        <p>
                           I am currently studying computer science at United
                           International University as a freshman.
                        </p>
                        <p>
